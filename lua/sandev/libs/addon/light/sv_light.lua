...
function SEv.Addon:BurnSimfphysLights(vehicle)
...
hook.Add("OnEntityCreated", "sev_light_spawned", function(ent)
...
function SEv.Addon:AddWiremodLightFunctions(ent)
...
function SEv.Addon:AddAdvLightEntsFunctions(ent)
